...
{
    internal class Publish2Go : FSConsole
    {
        public String Package { get; private set; }
        public String Version { get; private set; }
        public String Setting { get; private set; }

        public Publish2Go(XElement xe, ExecutableContainer container, int indent)
            : base(xe, container, indent)
        {
            ...
            this.Arguments = "\\PUBLISH2GO \\PACKAGE \"" + this.Package + "\" \\VERSION \"" + this.Version + "\""
        ...
        public override string Description
        {
            get
            {
                return "FS " + this.FSVer.ToString(2) + " " + this.Rep + " Publish2Go "
